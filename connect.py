...
def main():
    ...
    azure_openai_key = os.getenv("OPENAPI_KEY")  # Replace with your actual key. if you don't have one, get from Azure or from Community https://curious.pm
    azure_openai_endpoint = os.getenv("OPENAPI_ENDPOINT_URL")  # Replace with your actual endpoint URL
